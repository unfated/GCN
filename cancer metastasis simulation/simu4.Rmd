...
hist(my_vaf[my_vaf>0],breaks = 500,xlab = 'allelic frequency f (0,0.5)',main='my_vaf',col='blue',xlim=c(0,0.5))
hist(my_vaf_prim[my_vaf_prim>0],breaks=seq(0,1,0.000001),xlab='allelic frequency f (0,0.0005)',main='my_vaf_prim',col='blue',xlim=c(0,0.0005))
hist(my_vaf_prim[my_vaf_prim>0],breaks = 500,xlab = 'allelic frequency f (0,0.5)',main='my_vaf_prim',col='blue',xlim=c(0,0.5))
hist(my_vaf_meta[my_vaf_meta>0],breaks=seq(0,1,0.000001),xlab = 'allelic frequency f (0,0.0001)',main='my_vaf_meta',col='blue',xlim=c(0,0.0001))
hist(my_vaf_meta[my_vaf_meta>0],breaks = 500,xlab='allelic frequency f (0,0.5)',main='my_vaf_meta',col='blue',xlim=c(0,0.5))
```
...
- 生长总时间：t约等于21
- 总变异数：约420万
- 出现转移有2个细胞；最终有约70000个转移的细胞,里面约300万个变异
