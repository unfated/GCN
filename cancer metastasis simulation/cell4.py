# -*- coding: utf-8 -*-
"""
Created on Mon Jul  8 03:37:23 2019
...
b=math.log(2) # 出生率
d=0.5 # 死亡率
nend=3000# 细胞总数 20微米大小 1厘米可以检测到 那么边长有500个 立体就有125000000个 1000万个 这里用10万个先
s=[0] # 适合度，中性进化
mu=100 # 突变率
ploidy=2 #二倍体
tevent=[3] # 产生亚克隆的时刻，表示早转移和晚转移 #0.1,0.2,0.5,1,2,5,10
read_depth=100 # 测序阅读深度
